...
namespace PuntoDeVenta.DAO
{
    public class DAOClave_scaner
    {
        public dto_clave_scaner Getclave_scaner(int id)
        {
            ...
            cmd.CommandText = "SELECT * FROM clave_scanner WHERE id_usuario=" + id + ";";
        ...
        public dto_clave_scaner Getclave_scaner(string id)
        {
            ...
            //commands represent a query or a stored procedure
            SqlCeCommand cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT * FROM clave_scanner WHERE clave='" + id + "';";
            SqlCeDataReader reader = cmd.ExecuteReader();
        ...
        public List<dto_clave_scaner> Getclave_scaner()
        {
            ...
            //commands represent a query or a stored procedure
            SqlCeCommand cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT * FROM clave_scanner;";
            SqlCeDataReader reader = cmd.ExecuteReader();
        ...
        public void InsertClave_scanner(dto_clave_scaner usuario)
        {
            ...
            try
            {
                ...
                SqlCeCommand cmd = conn.CreateCommand();
                cmd.CommandText = "INSERT INTO clave_scanner ([clave]) Values('" + usuario.contrasenia + "')";
        ...
        public void Deleteclave_scanner(int id)
        {
            ...
            try
            {
                ...
                SqlCeCommand cmd = conn.CreateCommand();
                cmd.CommandText = "DELETE FROM clave_scanner WHERE id_usuario=" + id;
        ...
        public void AsignarClave(Usuarios usuario) 
        {
           ...
           // scaner.id_usuario = usuario.id_usuario;
